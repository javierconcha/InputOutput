...
rule2 = LUTconcInput==2 & ...
    LUTconc(:,1)>=CHlimit & LUTconc(:,1)~=30 & LUTconc(:,1)~=45 & LUTconc(:,1)~=50 &...
...
rule6 = LUTInputused==2&...
    LUTconcused(:,1)==60 & LUTconcused(:,2)==28.00 &...
    LUTconcused(:,3)==1.249;
...
rule6 = LUTInputused==2&...
    LUTconcused(:,1)==90 & LUTconcused(:,2)==28.00 &...
    LUTconcused(:,3)==1.249;
...
rule6 = LUTInputused==2&...
    LUTconcused(:,1)==15.0 & LUTconcused(:,2)==5.00 &...
    LUTconcused(:,3)==1.249;
